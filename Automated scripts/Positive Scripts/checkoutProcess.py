# Automated script for the Checkout process (positive)
import time
...
increaseQuantity = driver.find_element(By.NAME, "plus")
# Clicking on the '+' button 5 times and increasing the quantity:
